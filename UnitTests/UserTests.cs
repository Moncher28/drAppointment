...
public class UserTests
{
    ...
    public void LoginIsEmptyOrNull_ShouldFail()
    {
        ...
        Assert.Equal("Login was not specified", res.Error); // убеждаемся, что ошибка именно та
    }
    ...
    public void UserNotFound_ShouldFail()
    {
        ...
        Assert.True(res.IsFailure); // Ожидаем, что вернет ошибку
        Assert.Equal("User not found", res.Error); // убеждаемся, что ошибка именно та
    }
    ...
    public void CheckUserLoginOrPasswordIsEmptyOrNull_ShouldFail()
    {
        ...
        Assert.True(res.IsFailure); // Ожидаем, что вернет ошибку
        Assert.Equal("Login or Password was not specified", res.Error); // убеждаемся, что ошибка именно та
    }
    ...
    public void CheckUserExists_ShouldFail()
    {
        ...
        Assert.True(res.IsFailure); // Ожидаем, что вернет ошибку
        Assert.Equal("User not exists", res.Error); // убеждаемся, что ошибка именно та
    }
}